...
Ce workshop s'inscrit dans le cadre des journées [Montpellier Omics Days](https://montpellier-omics-days.fr/) organisées par les étudiants du [Master Bioinformatique](https://formations.umontpellier.fr/fr/formations/master-lmd-XB/master-bioinformatique-KKI9GZEV.html) et a été effectué par des étudiants du [master Statistiques et Sciences des Données](https://formations.umontpellier.fr/fr/formations/master-XB/master-mathematiques-ME157/statistique-et-science-des-donnees-ssd-KKIDCY8N.html) :
...
La méthode de clustering appliquée est `hclust` soit une méthode de classification hierarchique, la distance utilisée par défaut est celle de Ward.
