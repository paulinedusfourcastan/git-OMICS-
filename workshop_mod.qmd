...
Ce workshop MOD a été effectué par des étudiants du [master Statistiques et Sciences des Données](https://formations.umontpellier.fr/fr/formations/master-XB/master-mathematiques-ME157/statistique-et-science-des-donnees-ssd-KKIDCY8N.html) :
...
## Visualisation des 10 observations des données 
...
```{r}
#| code-fold: true
#| code-summary: "Voir le diagramme en barre"
#| output: true
...
```{r}
#| code-fold: true
#| code-summary: "Voir le heatmap pour chaque type de cancer"
#| output: true
...
![Schéma Explicatif de l'Utilisation de `ggplot`](./images/schéma_ggplot.png)
