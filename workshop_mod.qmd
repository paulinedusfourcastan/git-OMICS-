...
Ce workshop s'inscrit dans le cadre des journées [Montpellier Omics Days](https://montpellier-omics-days.fr/) organisées par les étudiants du [Master Bioinformatique](https://formations.umontpellier.fr/fr/formations/master-lmd-XB/master-bioinformatique-KKI9GZEV.html) et a été effectué sous la responsabilité de Tanguy Lefort (**tanguy.lefort\@umontpellier.fr**) et Élodie Brunel-Piccinini (**elodie.brunel-piccinini\@umontpellier.fr**) par des étudiants du [master Statistiques et Sciences des Données](https://formations.umontpellier.fr/fr/formations/master-XB/master-mathematiques-ME157/statistique-et-science-des-donnees-ssd-KKIDCY8N.html) :
...
Les données utilisées dans ce Workshop sont disponibles dans la librairie `OmicCircos` de `R`. Elles reposent sur les bases de données fournies par [***The Cancer Genome Atlas Program***](https://www.cancer.gov/ccg/research/genome-sequencing/tcga) (TCGA) contenant des données de patients atteints de différents sous-types de cancer du sein étant :

-   **Normal** qui, contrairement à ce que son nom pourrait sous-entendre, ne correspond pas à une absence de cellules cancéreuses

-   **LumA et Lum B** qui sont les sous-types de cancer du sein les plus aggressifs

-   **Basal**

-   **Her2**

Ces derniers sont davantage expliqués dans le [lexique](#lexique).

Pour la suite de l'atelier, les tableaux qui seront utilisés sont les suivants :
...
## Comparaison des comptages du nombrede mesures d'expresion génique de l'ARNmessager pour chacun des chromosomes
