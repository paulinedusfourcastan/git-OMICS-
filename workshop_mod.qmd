...
Pour pouvoir utiliser une librairie, il faut tout d'abord l'avoir installé à partir du [CRAN](https://cran.r-project.org/web/packages/) puis l'appeler à l'aide de la fonction `library()`.
...
# data cnv auquel on a enlevé les 3 premieres colonnes
...
# on selectionne les colonnes qui nous intéressent
mydata_1 <- chr1[, 3:18]
