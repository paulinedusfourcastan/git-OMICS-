...
L'objectif de ces premières visualisations est d'assimiler la construction de graphes en reprenant les concepts de base de la librairie *ggplot2* de R. Nous vous apprendront notamment à tracer des graphes de densités et des histogrammes. 
